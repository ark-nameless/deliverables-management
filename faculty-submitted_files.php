      ...
      <div class="container-fluid">
          ...
          <div class="row align-items-center">
            <div class="col-md-6">
              <div class="title mb-30">
                <h2 class="text-2xl font-semibold text-slate-600" >Deliverables Submitted Files</h2>
              </div>
            </div>
            <!-- end col -->
            <div class="col-md-6">
        ...
        <div class="flex flex-col w-full h-full border-2 border-slate-200 rounded-xl p-2 ">
            <table id="datatables_table" class="display hover table-striped" style="width:100%">
              ...
              <tbody>
                <?php 
                  $submitted_docs->renderSubmittedFilesTable($current_id);
                ?>
              </tbody>
            </table>
          </div>
