...
<body>
    ...
    <section class="section">
      <div class="container-fluid">
          ...
          <div class="row align-items-center">
            <div class="col-md-6">
              <div class="title mb-30">
                <h2 class="text-2xl font-semibold text-slate-600">Deliverables Faculty</h2>
              </div>
            </div>
            <!-- end col -->
            <div class="col-md-6">
        ...
        <div class="grid gap-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 mb-50">
          <button type="button" class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out" data-bs-toggle="modal" data-bs-target="#registerFaculty">Register Faculty</button>
        </div>
  ...
  <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="registerFaculty" tabindex="-1" aria-labelledby="registerFaculty" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-xl relative w-auto pointer-events-none">
      <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
        ...
        <form class='' action="scripts/routes/faculty_add_faculty.route.php" method="post">
          <div class="modal-body relative p-4 grid gap-2 grid-cols-1 md:grid-cols-2 w-full">
            <input type="hidden" class="form-control" id="role" name="role" placeholder="" value="faculty">
            <div class="form-floating mb-3">
              <input type="text" class="form-control" id="faculty_id" name="faculty_id" placeholder="" required>
            ...
            <div class="col-span-full modal-footer">
              ...
              <button type="submit" class="btn btn-primary bg-blue-900">Register Faculty</button>
            </div>
          </div>
        </form>
      </div>
