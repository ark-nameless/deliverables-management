<?php
  ...
  require_once $_SERVER['DOCUMENT_ROOT'] . '/scripts/controllers/message.controller.php';
  ...
  <main class="main-wrapper">
    ...
    <section class="section">
      <div class="container-fluid">
          ...
          <div class="row align-items-center">
            <div class="col-md-6">
              <div class="title mb-30">
                <h2 class="text-2xl font-semibold text-slate-600" >Deliverables Messages</h2>
              </div>
            </div>
            <!-- end col -->
            <div class="col-md-6">
        ...
        <!-- ========== title-wrapper end ========== -->
        <div class="grid gap-2 grid-cols-1 md:grid-cols-3 mb-50">
          <div class="flex flex-col w-full h-96 border-2 rounded-xl p-2 overflow-y-auto space-y-2">
            <h1 class="text-xl font-semibold sticky top-0 bg-white rounded-xl p-2 mb-3">Contacts</h1>
            <?php 
              $messenger->renderContacts($current_id, $session->get('role'));
            ?>
          </div>
          <div class="col-span-2 flex flex-col justify-between w-full h-96 border-2 rounded-xl p-2">
              <h1 class="text-xl font-semibold sticky top-0 bg-white rounded-xl p-2 mb-3"><?php echo $_GET['name'] ?></h1>


              <div class="flex flex-col w-full h-full overflow-y-auto bg-white rounded-xl p-2 mb-3 space-y-4">
                <?php 
                  $messenger->renderMessages($current_id, $_GET['from']);
                ?>
              </div>

              <form class="flex space-x-2" action="scripts/routes/message_send_message.route.php" method="post">
                <input type="hidden" name="from" value="<?php echo $current_id?>">
                <input type="hidden" name="to" value="<?php echo $_GET['from']?>">
                <input type="text" class="form-control" placeholder="Message" name="contents">
                <button class="input-group-text w-fit" id="basic-addon1">Send</button>
              </form>
          </div>
        </div>
