<?php
  ...
  require_once $_SERVER['DOCUMENT_ROOT'] . '/scripts/controllers/activity.controller.php';
...
<body>
          ...
          <div class="row align-items-center">
            <div class="col-md-6">
              <div class="title mb-30">
                <h2 class="text-2xl font-semibold text-slate-600" >Deliverables Activities</h2>
              </div>
            </div>
            <!-- end col -->
            <div class="col-md-6">
  ...
  <!-- MODALS -->
  <div class="modal fade" id="newActivity" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <form action="/scripts/routes/activity_add_activity.route.php" method="post">
          <h1 class="modal-title fs-5" id="staticBackdropLabel">Add New Semester</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <div class="form-floating mb-3">
            <input type="text" class="form-control" placeholder="1st" aria-label="1st" id="activity_name" name="activity_name" aria-describedby="basic-addon1" required>
            <label for="activity_name" for="floatingInput">Activity Name</label>
          </div>
          <div class="form-floating mb-3">
            ...
            <label for="description" for="floatingInput">Activity Description</label>
          </div>
          <div class="form-floating mb-3">
            <input type="date" class="form-control" placeholder="1st" aria-label="1st" id="activity_date" name="activity_date" aria-describedby="basic-addon1" required>
            <label for="activity_date" for="floatingInput">Activity Date</label>
          </div>
        </div>
