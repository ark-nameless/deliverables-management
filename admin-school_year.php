...
<body>
      ...
      <div class="container-fluid">
          ...
          <div class="row align-items-center">
            <div class="col-md-6">
              <div class="title mb-30">
                <h2 class="text-2xl font-semibold text-slate-600" >Deliverables School Year</h2>
              </div>
            </div>
            <!-- end col -->
            <div class="col-md-6">
        ...
        <div class="flex flex-col w-full h-full space-y-10">
          ...
          <div class="grid gap-5 grid-cols-1 md:grid-cols-3">
            <button class="text-xl font-semibold text-white p-2 text-center rounded-xl bg-red-900 hover:bg-red-900" data-bs-toggle="modal" data-bs-target="#newSchoolYear">Add New School Year</button>
          </div>
  ...
  <!-- MODALS -->
  <div class="modal fade" id="newSchoolYear" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <form action="/scripts/routes/schoolyear_add_sy.route.php" method="post">
          <h1 class="modal-title fs-5" id="staticBackdropLabel">Add New School Year</h1>
