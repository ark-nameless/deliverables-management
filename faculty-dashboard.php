<?php
  ...
  $files_submitted = $submitted_docs->get($current_id);

  $all_activities = $activities->getAll();
          ...
          <div class="row align-items-center">
            <div class="col-md-6">
              <div class="title mb-30">
                <h2 class="text-2xl font-semibold text-slate-600" >Deliverables Dashboard</h2>
              </div>
            </div>
            <!-- end col -->
            <div class="col-md-6">
        ...
        <div class="grid gap-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 mb-50">
          <div class="">
            <div class="icon-card">
              ...
              <div class="content">
                <h6 class="">Files Submitted</h6>
                <h3 class="text-bold text-2xl">
                  <?php
                    echo count($files_submitted);
                  ?>
                </h3>
              </div>
            </div>
          ...
          <div class="">
            <div class="icon-card">
              ...
              <div class="content">
                <h6 class="">Unattended Documents</h6>
                <h3 class="text-bold text-2xl">
                  <?php 
                    echo count($files_to_submit);
                  ?>
                </h3>
              </div>
            </div>
          ...
          <div class="">
            <div class="icon-card">
              ...
              <div class="content">
                ...
                <h3 class="text-bold text-2xl"><?php echo count($all_activities); ?></h3>
              </div>
            </div>
          </div>
        </div>
